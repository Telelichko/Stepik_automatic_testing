from proj_4311_locators import ProductPageLocators    # Импорт класса, описывающего главную страницу
from proj_4311_base_page import BasePage            # Импорт базового класса BasePage
