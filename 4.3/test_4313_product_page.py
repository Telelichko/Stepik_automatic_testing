from proj_4313_product_page import ProductPage
from proj_4313_login_page import LoginPage
from proj_4313_cart_page import CartPage
import pytest
import time
...
class TestGuestAddToCartFromProductPage(object):
    ...
    def test_guest_get_correct_product_name_in_msg(self, browser):
        page = ProductPage(browser, self.product_link)
        page.open()
        page.add_product_to_cart()
...
class TestUserAddToCartFromProductPage(object):
    ...
    def test_user_get_correct_product_name_in_msg(self, browser):
        page = ProductPage(browser, self.product_link)
        page.open()
        page.add_product_to_cart()
        page.get_product_name_in_msg_success()
