from proj_4305_locators import ProductPageLocators    # Импорт класса, описывающего главную страницу
from proj_4305_base_page import BasePage            # Импорт базового класса BasePage
