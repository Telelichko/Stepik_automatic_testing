from proj_4313_locators import ProductPageLocators    # Импорт класса, описывающего главную страницу
from proj_4313_base_page import BasePage            # Импорт базового класса BasePage
