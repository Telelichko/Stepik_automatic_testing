from proj_4306_locators import ProductPageLocators    # Импорт класса, описывающего главную страницу
from proj_4306_base_page import BasePage            # Импорт базового класса BasePage
