from proj_4310_main_page import MainPage    # Импорт класса, описывающего главную страницу
from proj_4310_login_page import LoginPage
from proj_4310_cart_page import CartPage
import time
